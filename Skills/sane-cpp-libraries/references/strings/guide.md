...
Use this guide when the user needs formatting, conversion, encoding-aware string work, or path manipulation. Keep the guidance tied to non-owning string handling and the public string helpers.

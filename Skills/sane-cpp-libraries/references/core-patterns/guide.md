...
- Use this guide when the user needs Sane-wide coding rules more than one specific library.
...
- Route buffer and allocator questions to `memory`.
- Route string-formatting questions to `strings`.
- Route callback and handle-wrapper questions to `foundation`.
- Route container-selection questions to `containers`.

...
Use this guide when the user needs to choose or understand a Sane container type. Focus on capacity, allocation behavior, and the relationship between containers and `Memory`.

...
Use this guide when the user needs to measure time, represent timestamps, or choose between monotonic and realtime semantics. Keep the guidance tied to the public `SC::Time` types.

...
- Use this guide when you need to explain `SC.sh`, `SC.bat`, built-in tools, or custom tool invocation.
...
4. Route build-specific questions to `build` when the user is actually configuring `SC::Build`.

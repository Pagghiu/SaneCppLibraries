---
name: sane-build
description: SC::Build guidance for third-party AI agents using Sane C++ Libraries. Use when configuring SC-build.cpp, choosing generators or the native backend, exporting libraries for plugins, or integrating Sane C++ projects into a build system.
---
...
- Use this skill when you need to describe or consume `SC::Build`, `SC-build.cpp`, or the native backend.

...
- Use `sane-file` for reading or writing descriptor bytes.
- Use `sane-file-system-iterator` to discover entries before mutating them.
- Use `sane-strings` for display or normalization logic around paths.

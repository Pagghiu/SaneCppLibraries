---
name: sane-hashing
description: Sane C++ hashing guidance for third-party AI agents. Use when computing MD5, SHA1, or SHA256 hashes for streams of bytes, files, or cache keys, or when choosing the right hashing entrypoint from the public API.
---
...
- Use this skill when the user needs a checksum or digest from bytes or a stream.

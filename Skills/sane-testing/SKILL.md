---
name: sane-testing
description: Sane C++ testing framework guidance for third-party AI agents. Use when reading or writing library tests, learning the test layout, invoking SCTest, or using tests as examples for a Sane library.
---
...
- Use this skill when the user asks about the Sane test framework or where to find examples of library behavior.
...
4. Route library-specific behavior questions back to the matching skill after using tests as examples.
...
- Do not duplicate the library-specific guidance that belongs in the per-library skills.

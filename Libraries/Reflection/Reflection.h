...
#include "../Foundation/Language/Limits.h" // MaxValue
...
// clang-format off
template <> struct MetaClass<char>   : public MetaPrimitive {static constexpr MetaType getMetaType(){return MetaType::TypeUINT8;}};

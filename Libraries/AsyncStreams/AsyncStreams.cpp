...
//-------------------------------------------------------------------------------------------------------
SyncZLibTransformStream::SyncZLibTransformStream() {}

Result SyncZLibTransformStream::asyncWrite(AsyncBufferView::ID bufferID, Function<void(AsyncBufferView::ID)> cb)
{
...
bool SyncZLibTransformStream::canEndWritable()
{

...
template SC_MEMORY_EXPORT bool Segment<detail::SegmentBuffer>::assign<char>(Span<const char>) noexcept;
template SC_MEMORY_EXPORT bool Segment<detail::SegmentBuffer>::append<char>(Span<const char>) noexcept;

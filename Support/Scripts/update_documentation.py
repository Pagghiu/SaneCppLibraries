...
and generates a Markdown file listing direct and indirect dependencies for each library.

How it works (step by step):

1. Identifies all libraries as subfolders of Libraries/ (ignores LibrariesExtra/).
...
7. For each library, updates or inserts a '# Dependencies' section in its documentation file (Documentation/Libraries/{Library}.md):
   - The section lists direct and all dependencies, using the same link format as above.
   - The section is inserted before the '# Features' section if present, or at the end otherwise.
   - Any existing '# Dependencies' section is replaced.
...
This will update Documentation/Pages/Dependencies.md and the # Dependencies section of each library's documentation file with the latest dependency information.
"""
import os
import re
import sys

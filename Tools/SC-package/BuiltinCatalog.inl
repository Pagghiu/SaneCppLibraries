...
static constexpr PackageRegistryEntry BuiltinPackageRegistryEntries[] = {
    ...
    {"linux-sysroot-musl-arm64", "linux-sysroot-musl-arm64", PackageKind::Sysroot, "Linux musl arm64 sysroot",
     "linux-musl-arm64", "Alpine APK index", false, LinuxSysrootExports, LinuxSysrootPhases,
     installLinuxSysrootMuslArm64Entry},
    {"wine", "wine-stable", PackageKind::Runner, "Wine runner for Windows targets", "host",
     "Wine release archive or Linux DEBs", false, WineExports, WinePhases, installWineEntry},
    {"msvc", "msvc", PackageKind::Toolchain, "Portable MSVC and Windows SDK toolchain",
     "windows-msvc-x64/windows-msvc-arm64", "Portable MSVC vendor fetch or import", true, MSVCExports, MSVCPhases,
     installMSVCEntry},
};

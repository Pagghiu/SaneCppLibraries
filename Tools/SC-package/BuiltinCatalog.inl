...
static constexpr PackageRegistryEntry BuiltinPackageRegistryEntries[] = {
    {"doxygen", "doxygen", PackageKind::Tool, "Documentation generator binary", "host", "GitHub release archive", false,
    ...
    {"clang", "clang-binaries", PackageKind::Tool, "Pinned host clang-format binary", "host", "Official LLVM release archive",
     false, ClangExports, ClangPhases, installClangEntry},
    {"llvm", "llvm", PackageKind::Toolchain, "Pinned host LLVM toolchain", "host", "Official LLVM release archive", false,
     LLVMExports, LLVMPhases, installLLVMEntry},
    {"qemu", "qemu", PackageKind::Runner, "Imported QEMU user-mode runner registration", "host", "Imported directory or PATH",
     true, QEMUExports, QEMUPhases, installQEMUEntry},
    {"filc", "filc", PackageKind::Toolchain, "Experimental Fil-C compiler toolchain", "linux-x86_64", "Pinned archive or import",
     true, FilCExports, FilCPhases, installFilCEntry},
    {"llvm-mingw", "llvm-mingw", PackageKind::Toolchain, "LLVM MinGW Windows GNU toolchain", "host", "llvm-mingw release archive",
    ...
    {"linux-sysroot-glibc-arm64", "linux-sysroot-glibc-arm64", PackageKind::Sysroot, "Linux glibc arm64 sysroot",
    ...
    {"linux-sysroot-musl-x86_64", "linux-sysroot-musl-x86_64", PackageKind::Sysroot, "Linux musl x86_64 sysroot",
     "linux-musl-x86_64", "Alpine APK index", false, LinuxSysrootExports, LinuxSysrootPhases,
     installLinuxSysrootMuslX64Entry},
    {"linux-sysroot-musl-arm64", "linux-sysroot-musl-arm64", PackageKind::Sysroot, "Linux musl arm64 sysroot", "linux-musl-arm64",
     "Alpine APK index", false, LinuxSysrootExports, LinuxSysrootPhases, installLinuxSysrootMuslArm64Entry},
    {"wine", "wine-stable", PackageKind::Runner, "Wine runner for Windows targets", "host", "Wine release archive or Linux DEBs",
     false, WineExports, WinePhases, installWineEntry},
    {"msvc", "msvc", PackageKind::Toolchain, "Portable MSVC and Windows SDK toolchain", "windows-msvc-x64/windows-msvc-arm64",
